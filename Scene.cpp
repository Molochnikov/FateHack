...
Class *Scene::atPut(Directive key, Class *arg) {
  switch (key) {
    case Class::Directive::Greater: //atPut set min path in autogenerated scene
      _min_path_proto = arg->clone();
      return this;
      break;
    case Class::Directive::Less: //atPut set max path in autogenerated scene
    ...
    case Class::Directive::Cursor: //set cursor on owner of arg
      ...
      break;
    case Class::Directive::Near: //check arg is near the cursor
      {
        Class * cls = 0;
