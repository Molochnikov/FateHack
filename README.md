...
case Class::Directive::Greater: //atPut set min path in autogenerated scene to arg

case Class::Directive::Less: //atPut set max path in autogenerated scene to arg

case Class::Directive::Cursor: //atPut set cursor on owner of arg

case Class::Directive::Near: //atPut check arg is near the cursor
